...
export const AuthProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ currentUser, setCurrentUser, guestCart, addToCart, addToFavorites, removeFromCart, updateQuantityInCart, updateUserCartOnServer, clearCartAndSaveOrder, removeFromFavorites, signOut}}>
      {children}
